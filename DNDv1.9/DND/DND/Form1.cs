            ...
            foreach (var file in files)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        FileDecrypt(file, file.Substring(0, file.Length - 4), heslo);
                        fileAsBytes = File.ReadAllBytes(file.Substring(0, file.Length - 4));
